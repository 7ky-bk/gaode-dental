  ...
  function tryLoad(idx) {
    ...
    img.onload = function() {
     ...
     var imgEl = document.createElement('img');
      imgEl.src = 'assets/images/gallery/' + idx + '.jpg';
      imgEl.alt = '环境实拍';
      imgEl.loading = 'lazy';
    ...
    img.src = 'assets/images/gallery/' + idx + '.jpg';
  }
  tryLoad(1);
})();
...
window.openMap = function() {
  var start = Date.now();
  window.location.href = "https://ditu.amap.com/search?query=%E8%B5%A3%E5%B7%9E%E5%B8%82%E9%BB%84%E9%87%91%E5%B2%AD%E9%AB%98%E5%BE%B7%E5%8F%A3%E8%85%94";
  setTimeout(function() {
    if (Date.now() - start < 3000) {
      window.location.href = "https://map.baidu.com/search/%E8%B5%A3%E5%B7%9E%E5%B8%82%E9%BB%84%E9%87%91%E5%B2%AD%E9%AB%98%E5%BE%B7%E5%8F%A3%E8%85%94";
    }
  }, 2500);
};
...
// ===== 荣誉墙滚动动画（JS 驱动）=====
(function() {
  var inner = document.querySelector(".honor-awards-inner");
  if (!inner) return;
  var firstItem = inner.querySelector(".honor-award-item");
  if (!firstItem) return;
  var mRight = parseFloat(window.getComputedStyle(firstItem).marginRight) || 16;
  var itemW = firstItem.offsetWidth + mRight;
  var setW = itemW * 9;
  var pos = 0; var lastT = 0;
  function frame(t) {
    if (lastT) {
      pos -= 50 * (t - lastT) / 1000;
      if (Math.abs(pos) >= setW) pos += setW;
